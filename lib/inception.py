...
qw = np.load('/data/lisatmp3/anirudhg/cifar_walk_back/walkback_-170211T225039/batch_3400_samples_backward_epoch_18_time_step_34.npz')

qwer = qw['X']
images = []
for i in range(100):
    images.append(qwer[i] * 255)
...
real_batch = train[0:100]

batch_lst = []

for i in range(0,100):
    batch_lst.append(real_batch[i])
